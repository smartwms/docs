...
Triangulação usa as propriedades geométricas de triângulos para estimar a distância ao alvo por meio da computação de medidas angulares de dois pontos fixos de referencia.
A posição de um objetos é encontrada na intercecção de dois pares de linhas de direção de ângulo.
Nessa caso, a propriedade de sinal que esta diretamente envolvida é o AoA.
...
Nesse método o alguma propriedade do sinal forne-se a distancia relativa aos pontos conhecidos.
...
É o algorimo mais simples, entretanto só é utilizado para saber a distancia de um objeto de interesse e não sua localização. Por tanto foge do escopo do presente trabalho.
